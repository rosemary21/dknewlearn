...
const TutorResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${api_url}/staff/resetpassword`, formData);
      ...
      <div className="auth-container">
        <div className="single-div">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button className="submit-btn" disabled={loading} >{loading ? "Loading..." : "Reset Password"}</button>
          </form>
